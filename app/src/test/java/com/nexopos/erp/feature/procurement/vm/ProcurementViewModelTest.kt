...
/**
 * Unit tests for [ProcurementViewModel].
 */
@OptIn(ExperimentalCoroutinesApi::class)
class ProcurementViewModelTest {

    private val testDispatcher = StandardTestDispatcher()
    private lateinit var api: NexoApi
    private lateinit var settingsRepository: SettingsRepository
    private lateinit var viewModel: ProcurementViewModel
    ...
    fun setup() {
        ...
        viewModel = ProcurementViewModel(api, settingsRepository)
    }
    ...
    @Test
    fun `loadProcurements updates state`() = runTest {

...
/**
 * Unit tests for [ManufacturingViewModel].
 */
@OptIn(ExperimentalCoroutinesApi::class)
class ManufacturingViewModelTest {

    private val testDispatcher = StandardTestDispatcher()
    private lateinit var api: MobileApi
    private lateinit var settingsRepository: SettingsRepository
    private lateinit var viewModel: ManufacturingViewModel
    ...
    fun setup() {
        ...
        viewModel = ManufacturingViewModel(api, settingsRepository)
    }
    ...
    @Test
    fun `loadProductionOrders updates state`() = runTest {
